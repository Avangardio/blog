...
import {GetExactPostOutputDto, GetExactPostQueryDto,} from '@/DTO/posts/getExactPost';
import {DeleteExactPostBodyDto, DeleteExactPostOutputDto,} from '@/DTO/posts/deletePost';
