...
describe('UserService', () => {
  ...
  it('setNewUser - юзер есть', async () => {
    const result = await userService.setNewUser({
  ...
  it('updateUserPassword - юзер есть', async () => {
    const result = await userService.updateUserPassword(String(1), '1231');
