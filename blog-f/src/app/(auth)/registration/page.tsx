...
export default function LoginPage() {
    ...
    return (
        <div className={'bg-white p-2 rounded-s'}>
            <div
                className={'font-medium text-2xl text-cyan-800 z-50 mb-5 border-b-2 border-cyan-600 text-center'}>{headers.registration}</div>
            <Formik
                initialValues={{
                    password: '',
                    name: '',
                        ...
                        <Form id='reg-form' className="relative flex-col flex justify-center z-40">
                            <div>
                                <label className={'px-5 block font-medium text-sm text-cyan-700'}
                                       htmlFor={'name'}>{inputHeader.nameHeader}</label>
                                <Field name="name"
                                       className={`
                            ...
                            <div className={' px-5 my-2 relative'}>
                                ...
                                <div className={'ml-2'}>
                                    <div
                                        className={` block font-medium text-sm text-cyan-800`}>{termsOfUse.terms1}</div>
                                    <p><a
                                        className={` text-cyan-500 cursor-pointer text-sm border-b-cyan-500 border-b-2`}>{termsOfUse.terms2}</a>
                                    </p>
                                </div>
                            </div>
